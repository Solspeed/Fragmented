      ...
      <div className="mt-4 h-auto md:h-[654px] mx-auto bg-zinc-950 rounded-[30px] overflow-hidden relative border border-[linear-gradient(to bottom, #ffffff 100%, #000000 10%)] p-4 md:p-0">
        ...
        <div className="mt-[68px] px-4 md:px-0 md:absolute left-1/2 transform md:-translate-x-1/2 w-full max-w-[782px]">
          <div className="mx-auto h-60 text-center">
            ...
            <div
              className={`mt-4 md:mt-0 md:absolute left-1/2 transform md:-translate-x-1/2 top-[182px] w-full max-w-[760px] opacity-50 text-white text-base md:text-[22px] font-normal font-['Instrument Sans'] leading-6 md:leading-[34px] `}
            >
          ...
          <div className="mb-24 md:mt-0 md:absolute left-1/2 transform md:-translate-x-1/2 top-[290px] w-full max-w-[604px] h-[74px]  ">
            <div
              className=" w-full h-full bg-black bg-opacity-20 relative rounded-[37px] border-[0.8px]  border-white"
             
            >
            <div className="  w-fit z-50 p-1 absolute right-0 h-full flex flex-1">
              <div className="bg-violet-800 rounded-[37px] px-4 py-2 md:px-9 md:py-5 flex items-center ">
                <div className="text-white text-md md:text-lg font-medium font-['Instrument Sans']">
                  Get in touch
                </div>
              </div>
            </div>
